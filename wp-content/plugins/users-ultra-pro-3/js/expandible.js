...
(function($) {
    $(document).ready(function () { 
	   ...
	   "use strict";
		...
		$('body').on('click', '#new_video_add_confirm', function(e) {
		...
		$('body').on('click',"a[href='#resp_del_photo']", function(e) {
		...
		//edit gallery
		$("body").on("click", "a[href='#resp_edit_gallery']", function(e) {
		...
		$("body").on("click", ".btn-gallery-conf", function(e) {
		...
		$(document).on("click", "#uultra-btn-save-customizer-change", function(e) {
			
			e.preventDefault();		
			
			 $('#loading-animation-pro-builder').show(); 	
			
			
			var widegetList1 = $('#uultra-prof-customizar-1');
			var widegetList2 = $('#uultra-prof-customizar-2');
			var widegetList3 = $('#uultra-prof-customizar-3');
			...
			jQuery.ajax({
				...
				success: function(response){					
					 ...
					 $('#loading-animation-pro-builder').hide(); // Hide the loading animation
		...
		jQuery('.uultra-btn-widget-elements, .uultra-expandable-panel-heading-widgets').live('click',function(e)
		{
		...
		//save user settings			
		$(document).on("click", "#uultra-update-widget-custom-user-information", function(e) {
			
			e.preventDefault();
			
			var widget_id =  jQuery(this).attr("widget-id");
			
			var widget_custom_text =  $("#uultra_user_widget_cont_edition_"+widget_id).val();
		...
		//save user settings			
		$(document).on("click", ".uultra-edit-widget-content-html-editor", function(e) {
		...
		//remove profile bg
		$(document).on("click", "#uultra-remove-profile-bg", function(e) {
