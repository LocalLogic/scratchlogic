	...
	******************************************/
	...
	public function user_expiration_edit_form_confirm ()
	{
		...
		{		
			...
			$html .='<div class="user-ultra-success">'.__(" SUCCESS! The expiration date has been chnged ", "xoousers").'</div>';
	...
	public function edit_profile_form_admin( $user_id )
	{
		...
		$html .= '<input type="text" class="xoouserultra-input'.$required_class.' xoouserultra-datepicker" name="uultra-edit-user-expiration-date" id="uultra-edit-user-expiration-date" value="'.$this->get_user_meta_custom( $user_id,$meta).'"  title="'.$name.'"  '.$disabled.'/>';
	...
	public function get_basic_template($user_id, $atts, $display_country_flag,  $display_photo_rating, $gallery_type, $pic_size, $pic_type, $pic_boder_type,  $pic_size_type, $optional_fields_to_display, $cols)
	{
		...
		$html .=' <div class="uultra-inner">
            <div class="uultra-inner-menu">             
                 '.$this->get_top_profile_navigator_links($user_id).'                 
            </div>';
		...
		if($pic_type=='avatar')
		{
			...
			if ($author_pic  != '') 
			{
				...
				if($this->validate_gravatar($user->user_email))
				{
					...
					$avatar_pic = 'http://1.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536?s='.$size.'';
