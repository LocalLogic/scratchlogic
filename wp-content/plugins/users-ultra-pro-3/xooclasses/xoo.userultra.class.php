...
class XooUserUltra
{
	...
	public function intial_settings()
	{
		...
		add_action( 'save_post',  array( &$this, 'uultra_custom_save_post_feature' ));
	...
	{	
		...
		if($admin_post=='no' && $is_admin && $logged_user_id== $post->post_author){  return $post_id;}
		...
		if($site_wide_post=='no'){  return $post_id;}	
...
[usersultra_directory list_per_page=8 optional_fields_to_display='friend,social,country,description' pic_boder_type='rounded']",
	...
	public function show_login_form( $sidebar_class=null, $redirect_to=null, $args) 
	{
		...
		$display .='<h2 class="uultra-forms-header">'.__("Sign in ",'xoousers' ).'</h2>';	
...
*/
		...
		if($this->get_option('mailchimp_active')==1 && $this->get_option('mailchimp_api')!="")
		{
			...
			//$display .= '</label>';
			$display .= '<div class="xoouserultra-field-value">';
			$display .= '<input type="checkbox"  title="'.__('Receive Daily Updates ', 'xoousers').'" name="uultra-mailchimp-confirmation"  id="uultra-mailchimp-confirmation" value="1"  '.$mailchimp_auto.' > <label for="uultra-mailchimp-confirmation"><span></span>'.$mailchimp_text.'</label></div>' ;
	...
	public function uultra_get_terms_and_conditions()
	{
		...
		$display .= '<div class="xoouserultra-field-value">';
		$display .= '<input type="checkbox"  title="'.__('Terms & Conditions ', 'xoousers').'" name="uultra-terms-and-conditions-confirmation"  id="uultra-terms-and-conditions-confirmation" value="1" class="validate[required]" > <label for="uultra-terms-and-conditions-confirmation"><span></span>'.$text_terms.'</label>'.$text_terms_large.'</div>' ;
		...
		if($text_terms!='')
		{
			...
			$display .= '<div class="xoouserultra-field-value">';
			$display .= '<input type="checkbox"  title="'.__('Terms & Conditions ', 'xoousers').'" name="uultra-terms-and-conditions-confirmation-2"  id="uultra-terms-and-conditions-confirmation-2" value="1" class="validate[required]" > <label for="uultra-terms-and-conditions-confirmation-2"><span></span>'.$text_terms.'</label>'.$text_terms_large.'</div>' ;
		...
		if($text_terms!='')
		{
			...
			$display .= '<div class="xoouserultra-field-value">';
			$display .= '<input type="checkbox"  title="'.__('Terms & Conditions ', 'xoousers').'" name="uultra-terms-and-conditions-confirmation-3"  id="uultra-terms-and-conditions-confirmation-3" value="1" class="validate[required]" > <label for="uultra-terms-and-conditions-confirmation-3"><span></span>'.$text_terms.'</label>'.$text_terms_large.'</div>' ;
		...
		if($text_terms!='')
		{
			...
			$display .= '<div class="xoouserultra-field-value">';
			$display .= '<input type="checkbox"  title="'.__('Terms & Conditions ', 'xoousers').'" name="uultra-terms-and-conditions-confirmation-4"  id="uultra-terms-and-conditions-confirmation-4" value="1" class="validate[required]" > <label for="uultra-terms-and-conditions-confirmation-4"><span></span>'.$text_terms.'</label>'.$text_terms_large.'</div>' ;
	...
	public function get_social_buttons_short_code ($atts)
	{
		...
		$FACEBOOK_APPID = $this->get_option('social_media_facebook_app_id');  
			...
			$action_text = __('Connect ','xoousers');
