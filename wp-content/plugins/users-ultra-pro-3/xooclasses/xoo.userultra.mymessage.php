...
class XooUserMyMessage {
	...
	public function send_private_message_to_admin()
	{
		...
		{			
			...
			echo "<div class='uupublic-ultra-error'>".__(" Message wasn't sent ", 'xoousers')."</div>";
		...
		if ( current_user_can( 'manage_options' ) ) 
		{
			/* A user with admin privileges won't see it*/
				...
				if($send_admin=='yes' )
				{
					...
					$html .= '<a href="#" id="uultra-send-private-message-box-to-admin"  title="'.__('Contact Admin','xoousers').'" ><i class="fa fa-lg fa-envelope uultra-icon-menu"></i><span class="uultra-top-nav-labels-resp">'.__(' Contact Admin','xoousers').'</span></a> ';
	...
	function show_my_messages_msg_box_to_user_directory()
	{
		...
		if ( empty( $msgs ) )
		{
			...
			foreach ( $msgs as $msg )
			{
				...
				$content = stripslashes($msg->content);
	...
	<div class="tablenav">
               ...
               <span style="float:left"><a href="?module=messages"><?php echo _e("Inbox", 'xoousers')?></a> | <a href="?module=messages_sent"><?php echo _e("Sent", 'xoousers')?></a></span>
  ...
  <div class="tablenav">
               ...
               <span style="float:left"><a href="?module=messages"><?php echo _e("Inbox", 'xoousers')?></a> | <a href="?module=messages_sent"><?php echo _e("Outbox", 'xoousers')?></a></span>
