...
class XooShortCode {
	...
	*/
	...
	{	
		...
		add_shortcode( 'usersultra_social', array(&$this,'usersultra_social_function') );		
		...
		//change log		
		add_shortcode( 'usersultra_changelog', array(&$this,'usersultra_changelog_function') );
		add_shortcode( 'usersultra_online_users', array(&$this,'function_online_users') );	
		
		//wall
		
		add_shortcode( 'usersultra_wall', array(&$this,'function_get_wall') );		
	...
	*/
	...
	public function  usersultra_changelog_function ($atts)
	{
		global $xoouserultra;
		return $xoouserultra->changelog->show_change_log( $atts );			
	}
	
	public function  function_get_wall ($atts)
	{
		global $xoouserultra;
		return $xoouserultra->wall->show_wall( $atts );			
	}
	
	
	
	public function  usersultra_social_function ($atts)
	{
		global $xoouserultra;					
		//display custom social
		return $xoouserultra->get_social_buttons_short_code( $atts );		
	}
	...
	//Online Users
	public function function_online_users( $atts ) 
	{
		global $xoouserultra;
		return $xoouserultra->userpanel->show_online_users( $atts );	
	}
	 ...
	 */
	 ...
	 function respo_pricing_shortcode( $atts, $content = null  ) 
	 {
		...
		$package_form = $package->package_registration_form	;
		...
		//check if custom form
		
		if($package_form!="")
		{
			$button_url = $button_url."&form_id=".$package_form;
