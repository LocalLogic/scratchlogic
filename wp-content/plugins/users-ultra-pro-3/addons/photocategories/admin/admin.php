...
class UsersUltraPhotoCate {
	...
	function __construct() {
		...
		$this->plugin_data = get_plugin_data( uultra_photcate_path . 'index.php', false, false);
	...
	function add_styles(){
		...
		wp_register_script( 'uultra_cate_js', uultra_photcate_url . 'admin/scripts/admin.js', array( 
			'jquery'
		) );
		wp_enqueue_script( 'uultra_cate_js' );
	
		wp_register_style('uultra_cate_css', uultra_photcate_url . 'admin/css/admin.css');
	...
	function get_tab_content() {
		...
		if( strstr($screen->id, $this->subslug ) ) {
			...
			require_once uultra_photcate_path.'admin/panels/'.$tab.'.php';
		}
	}
	...
	?>
		...
		<div class="wrap <?php echo $this->slug; ?>-admin">
           ...
           <h2>USERS ULTRA PRO -  <?php _e('PHOTO CATEGORY','xoousers'); ?></h2>
