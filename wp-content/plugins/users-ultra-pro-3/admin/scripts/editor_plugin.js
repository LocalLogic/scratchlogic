            ...
            menu: [
               ...
               //registration form
			   {
                    ...
                    menu: [
						...
						{
                            text: 'Custom Registration Form',
                            value: "[usersultra_registration custom_form='input here the form ID']",
                            onclick: function(e) {
                                e.stopPropagation();
                                editor.insertContent(this.value());
                            }       
				 ...
				 //social connects
			   {
                    ...
                    menu: [
                        {
                            text: 'Twitter',
                            value: "[usersultra_social provider='twitter']",
                            onclick: function(e) {
                                e.stopPropagation();
                                editor.insertContent(this.value());
                            }       
						 ...
						 {
                            text: 'Facebook',
                            value: "[usersultra_social provider='facebook']",
                            onclick: function(e) {
                                e.stopPropagation();
                                editor.insertContent(this.value());
                            }       
						...
						{
                            text: 'Yahoo',
                            value: "[usersultra_social provider='yahoo']",
                            onclick: function(e) {
                                e.stopPropagation();
                                editor.insertContent(this.value());
                            }       
						...
						{
                            text: 'Google',
                            value: "[usersultra_social provider='google']",
                            onclick: function(e) {
                                e.stopPropagation();
                                editor.insertContent(this.value());
                            }       
						...
						{
                            text: 'LinkedIn',
                            value: "[usersultra_social provider='linkedin']",
                            onclick: function(e) {
                                e.stopPropagation();
                                editor.insertContent(this.value());
                            }       
						...
						{
                            text: 'Yammer',
                            value: "[usersultra_social provider='yammer']",
                            onclick: function(e) {
                                e.stopPropagation();
                                editor.insertContent(this.value());
                            }       
						...
						{
                            text: 'All',
                            value: "[usersultra_social provider='facebook,yahoo,google,twitter,linkedin,yammer']",
                            onclick: function(e) {
                                e.stopPropagation();
                                editor.insertContent(this.value());
                            }       
				...
				//online users
			   {
                    ...
                    menu: [
                        {
                            text: 'Basic Style',
                            value: "[usersultra_online_users optional_fields_to_display='badges' item_width='105px']",
                            onclick: function(e) {
                                e.stopPropagation();
                                editor.insertContent(this.value());
                            }       
						 ...
						 {
                            text: 'Minified Users List Style',
                            value: "[usersultra_online_users template='mini' item_width='40px' pic_size='40']",
                            onclick: function(e) {
                                e.stopPropagation();
                                editor.insertContent(this.value());
                            }       
