...
?>
 ...
 <h1><?php _e('Welcome to Users Ultra Pro!','xoousers'); ?></h1>
        <div class="uu-sect-p">
        	            
            <p><?php _e("Thank you very much for installing Users Ultra Pro. ",'xoousers'); ?></p>
          ...
          <div class="statblock-social user-ultra-rounded">
           ...
           <table width="100%" class="wp-list-table widefat fixed posts table-generic">
			...
			<?php	} ?>
                 ...
                 <h3> <?php _e('Online Users', 'xoousers'); ?></h3>
