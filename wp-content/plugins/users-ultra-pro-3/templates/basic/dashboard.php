	...
	<div class="usersultra-dahsboard-left"> 
      ...
      <div class="pic" id="uu-backend-avatar-section">
            ...
            <?php echo $xoouserultra->userpanel->get_user_pic( $user_id, "", 'avatar', 'rounded', 'dynamic')?>
             ...
             <div class="btnupload">
             <a class="uultra-btn-upload-avatar" href="#" id="uu-send-private-message" data-id="<?php echo $user_id?>"><span><i class="fa fa-camera fa-2x"></i></span><?php echo _e("Upload Avatar", 'xoousers')?></a>
             </div>
