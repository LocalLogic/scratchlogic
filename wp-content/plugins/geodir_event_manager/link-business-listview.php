...
if ( !empty( $linked_listings ) ) {
	...
	?>
  <li id="post-<?php echo $post->ID;?>" class="clearfix <?php if($grid_view_class){ echo 'geodir-gridview '.$grid_view_class;}?> <?php if($post_view_class){echo $post_view_class;}?>">
    <article class="geodir-category-listing <?php if($post_view_article_class){echo $post_view_article_class;}?>">
      ...
      <div class="geodir-content">
        ...
        <div class="geodir-entry-content">
          <p>
            <?php if( isset( $character_count ) && $character_count != '' ) { 
